import os
from videocreator.generators.base import Generator
import soundfile as sf
from videocreator.utils.voice_gen import (
    generate_long_sentence_as_takes,
    save_audio_signal_wav,
    NEW_SAMPLE_RATE,
)
import torch
...
class VoiceoverGenerator(Generator):
    ...
    def generate(self, prompt: str, speaker: str, output_path: str, **kwargs):
        ...
        audio_array = generate_long_sentence_as_takes(
            prompt,
            speaker,
            speech_wpm=75,
